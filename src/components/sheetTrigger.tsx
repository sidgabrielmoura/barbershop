                ...
                <SheetContent>
                    ...
                    <section className="mt-10 flex flex-col gap-7">
                        ...
                        <div>
                            ...
                            {!data?.user ? (
                                <>
                                    <Button variant={'ghost'} onClick={() => setOpenDialog(true)} className="w-full justify-start">
                                ...
                                <Link href={'/bookings'}>
                                    <Button variant={pathname === '/bookings' ? "default" : "ghost"} className="w-full justify-start">
                                        <CalendarDays className="text-xl size-10" />
                                        <h1>Agendamentos</h1>
                                    </Button>
                                </Link>
